[_mysolution_--c81a] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [_mysolution_--c81a] container is NOT running**.

.. tip::
   You must have your [_mysolution_--c81a] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/NataliKobrii/fraud-detection/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/NataliKobrii/fraud-detection  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=35657  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='NataliKobrii'  \-\-env DOCKERUSERNAME='ddnatali'  \-\-env MQTTUSERNAME=''  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:9005/dashboard-ml.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
[_mysolution_--c81a] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/NataliKobrii/fraud-detection/tree/main/tml-airflow/dags/tml-solutions/_mysolution_
...
.. important::
   solution_preprocessing_ml_restapi_dag
...
.. important::
   VIPERHOST_PRODUCE=172.31.0.1, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.31.0.1, VIPERPORT_PREPROCESS=39695, VIPERHOST_PREPOCESS2=172.31.0.1, VIPERPORT_PREPROCESS2=36441, VIPERHOST_PREPOCESS_PGPT=172.31.0.1, VIPERPORT_PREPROCESS_PGPT=42197, VIPERHOST_ML=172.31.0.1, VIPERPORT_ML=33259, VIPERHOST_PREDCT=172.31.0.1, VIPERPORT_PREDICT=33367, HPDEHOST=172.31.0.1, HPDEPORT=34567, HPDEHOST_PREDICT=172.31.0.1, HPDEPORT_PREDICT=39983

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1268-_mysolution_--c81a,solution_preprocessing_ml_restapi_dag, python-predict-1991-_mysolution_--c81a,solution_preprocessing_ml_restapi_dag, python-preprocess-5066-_mysolution_--c81a,solution_preprocessing_ml_restapi_dag, python-ml-9502-_mysolution_--c81a,solution_preprocessing_ml_restapi_dag, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
