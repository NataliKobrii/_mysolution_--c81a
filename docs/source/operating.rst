...
.. important::
   https://github.com/NataliKobrii/fraud-detection-model/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/arimlabs/fraud-detection-model  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=9001  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='NataliKobrii'  \-\-env DOCKERUSERNAME='nataliiakobrii'  \-\-env MQTTUSERNAME=''  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   https://github.com/NataliKobrii/fraud-detection-model/tree/main/tml-airflow/dags/tml-solutions/_mysolution_
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.0.1, VIPERPORT_PREPROCESS=35421, VIPERHOST_PREPOCESS2=127.0.0.1, VIPERPORT_PREPROCESS2=33181, VIPERHOST_PREPOCESS_PGPT=127.0.0.1, VIPERPORT_PREPROCESS_PGPT=38415, VIPERHOST_ML=127.0.0.1, VIPERPORT_ML=35933, VIPERHOST_PREDCT=127.0.0.1, VIPERPORT_PREDICT=40305, HPDEHOST=127.0.0.1, HPDEPORT=44431, HPDEHOST_PREDICT=127.0.0.1, HPDEPORT_PREDICT=41419

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6775-_mysolution_--c81a,solution_preprocessing_ml_restapi_dag, python-preprocess-5557-_mysolution_--c81a,solution_preprocessing_ml_restapi_dag, python-predict-1540-_mysolution_--c81a,solution_preprocessing_ml_restapi_dag, python-ml-4413-_mysolution_--c81a,solution_preprocessing_ml_restapi_dag, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
